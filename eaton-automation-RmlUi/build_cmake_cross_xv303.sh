...
SDK_BASE="/opt/fslc-x11-eaton/xv303/4.0"
IMG_NAME="cortexa9t2hf-neon-fslc-linux-gnueabi"
...
BACKEND="X11_GL2" #backend is one of auto;native;Win32_GL2;Win32_VK;X11_GL2;SDL_GL2;SDL_GL3;SDL_VK;SDL_SDLrenderer;SFML_GL2;GLFW_GL2;GLFW_GL3;GLFW_VK;BackwardCompatible_GLFW_GL2;BackwardCompatible_GLFW_GL3
...
export CMAKE_INCLUDE_PATH=$base_folder/RmlUi/Include:$CMAKE_INCLUDE_PATH
export CMAKE_PREFIX_PATH=$base_folder/build_cmake/build_RmlUi:$CMAKE_PREFIX_PATH
